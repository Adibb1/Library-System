<x-app-layout>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-gray-100 dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg flex flex-wrap mb-2">
                <div class="p-6 text-gray-900 dark:text-gray-100 cursor-not-allowed">
            ...
            <div class="bg-gray-100 dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg flex flex-wrap">
                <div class="p-6 text-gray-900 dark:text-gray-100 cursor-pointer" onclick="readMessage('{{$URmessage->id}}')">
                    <p>{{ $URmessage->text }}</p>
