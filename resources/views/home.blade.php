<x-app-layout>
    ...
    <div class="py-12 bg-[#FFE8D6]">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="mb-4">
                <form method="GET" action="{{ route('books.index') }}" class="flex flex-wrap gap-4 text-[#6B705C]">
            ...
            <a class="text-white bg-[#6B705C] rounded py-2 px-2 hover:no-underline hover:text-white/70 hover:bg-[#A5A58D]" href="/home">Clear filters</a>

            <div class="flex flex-wrap justify-center gap-6 mt-8">
                @foreach ($books as $book)
                <div class="bg-[#B7B7A4] lg:w-[30%] md:w-[40%] w-[90%] h-[100%] rounded-xl flex flex-col justify-center items-center overflow-hidden shadow-sm p-6 text-[#3E3E3E] relative transition-all duration-500 cursor-pointer" onclick="toggleCardDetails(this)">
                    <div class="card-summary text-center">
                        <img class="h-[100px] w-[100px] object-cover mb-4 rounded-full" src="{{$book->picture}}" alt="{{$book->title}}">
